...
[source,xml,subs=attributes+]
----
include::example$querydsljpa_pom.xml[lines=16..19]
...
include::example$querydsljpa_pom.xml[lines=53..62]
----
...
[source,java]
----
include::example$QueryDslRepositoryFilter.java[lines=53..77]
----
