...
//TODO ? Aren't the latter attributes and not entities? Seems the sentences should end "... an attribute `addresses` that references a nested attribute `zipCode` and a list of `hobby` attributes."
