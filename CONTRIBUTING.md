# Contribution Guideline Bosch Semantic Stack Resource Query Language (RQL)

Thank you for your interest in contributing to the Bosch Semantic Stack RQL. Use this repository to contribute to
the Bosch Semantic Stack RQL as easy and transparent as possible, whether it is:
...
* We use this GitHub repository to track issues and feature requests [see](https://github.com/bci-oss/semanticstack-rql/issues).
* For general discussions of the Bosch Semantic Stack RQL we use [GitHub discussions](https://github.com/bci-oss/semanticstack-rql/discussions).
...
## Semantic Stack Contributor Licence Agreement

In order to be able to contribute to Semantic Stack projects you must electronically sign the
Semantic Stack [Contributor Licence Agreement](CLA.md).

When you open a PR, our Semantic Stack CLA Assistant will help you to make contributing easier.
So don't worry, just open PR and our assistance will help you with the [CLA](CLA.md) sign.
...
The Bosch Semantic Stack RQL is written in the Java Programming Language. Please have a look into our [Code
Conventions](CONVENTIONS.md).

## Versioning

We use Semantic Versioning to identify released versions of the Bosch Semantic Stack RQL. Semantic Versioning is
